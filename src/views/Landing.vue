...
<div>
  <div class="relative bg-white overflow-hidden">
        ...
        >
          <div class="sm:text-center lg:text-left">
            ...
            >
              ...
              Du littoral aux plaines et aux terrils. Venez jouer avec le vent.
            </p>
            <div
    ...
    <div class="relative lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 align-items-right">
      <picture>
        ...
        />
            ...
            <img class="object-cover absolute top-1 right-2 h-1/5" src="@/assets/img/LogoCDVL59.svg"/>
    </div>
  </div>
  <div><Footer/></div>
</div>
